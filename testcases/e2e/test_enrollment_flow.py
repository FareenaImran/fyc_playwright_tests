...
from src.pages.tp.dashboard.learners.tp_learners_page import TPLearnersPage
   ...
   """
    ...
    while True:
        ...
        if not already_enrolled:
            break
    #Verify Enrollment
    my_courses=MyCoursesPage(page)
    course_detail=await my_courses.verify_enrollment_appears_in_applied_courses(course_name)
    ...
    await page.get_by_text(TPLearnersPage.APPLICATION_TAB).click()
    ...
    #View Inquiries
    await page.get_by_text(AdminLocators.APPLICATION_TAB).click()
    # Check course name in table
